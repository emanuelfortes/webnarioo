...
export const steps: Step[] = [
  ...
  {
    key: 'tempo',
    label: 'Há quanto tempo o escritório existe?',
    type: 'options',
    opts: ['Menos de 2 anos', '2 a 5 anos', '5 a 10 anos', 'Mais de 10 anos'],
  },
  {
    key: 'faturamento',
    label: 'Qual o faturamento mensal médio do escritório?',
    type: 'options',
    opts: ['Até R$ 20 mil', 'R$ 20 a 50 mil', 'R$ 50 a 100 mil', 'Acima de R$ 100 mil'],
  },
  {
    key: 'investimento',
    label: 'Quanto você investe em marketing por mês hoje?',
    type: 'options',
    opts: ['Nada ainda', 'Até R$ 1 mil', 'R$ 1 a 3 mil', 'Acima de R$ 3 mil'],
  },
  {
    key: 'dificuldade',
    label: 'Qual sua maior dificuldade para atrair novos clientes hoje?',
    type: 'text',
    ph: 'Escreva com suas palavras',
  },
  {
    key: 'pronto',
    label:
      'Se o sistema fizer sentido para o seu escritório, você tem condições de investir na implantação nos próximos 30 dias?',
    type: 'options',
...
/** Só estas chaves são aceitas pelo servidor. */
export const CHAVES = steps.map((s) => s.key);
